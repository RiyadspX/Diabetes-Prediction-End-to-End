...
class DataTransformationConfig:
    '''DataTransformationConfig : définit la configuration pour
     la transformation des données, incluant le chemin où l'objet de prétraitement sera sauvegardé (preprocessor.pkl dans un dossier
      artifacts).
...
# Initialise the path config within the init
    def __init__(self):
        # initialiser une instance de config pour acceder facilement au path 
